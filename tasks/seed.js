...
dbConnection().then(db => {
    return db.dropDatabase().then(() => {
        ...
        return products.addProduct("016000275638", "General Mills Total Cereal", "http://ecx.images-amazon.com/images/I/51cGjp6uMmL._SL160_.jpg");
    }).then(() => {
        return products.addProduct("044000025298", "Nabisco Oreo ", "https://i5.walmartimages.com/asr/b0442517-0147-4703-a17b-a8e45684abef_1.2ec464c5751f281255d794398d9af225.jpeg?odnHeight=450&odnWidth=450&odnBg=ffffff");
    }).then(() => {
        //Pass = "1234"
